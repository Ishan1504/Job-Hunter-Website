      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <nav class="mx-auto site-navigation">
            <ul class="site-menu js-clone-nav d-inline d-xl-block ml-0 pl-0">
              ...
              <?php if(isset($_SESSION['username'])) : ?>
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="<?php echo APPURL; ?>/users/public-profile.php?id=<?php echo $_SESSION['id']; ?>">My profile</a>
                    <a class="dropdown-item" href="<?php echo APPURL; ?>/users/upd-profile.php?id=<?php echo $_SESSION['id']; ?>">Update profile</a>
