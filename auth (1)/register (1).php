      ...
      if($password == $repassword) {
        ...
        if(strlen($email) > 50 OR strlen($username) > 30 ) {
          ...
          if($validate->rowCount() > 0) {
            ...
            $insert = $conn->prepare("INSERT INTO users (username, email, mypassword, img, type, title, bio, facebook, twitter, linkedin) 
            VALUES (:username, :email, :mypassword, :img, :type, :title, :bio, :facebook, :twitter, :linkedin)");
            ...
            <form action="register.php" class="p-4 border rounded" method="POST">
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input type="text" id="fname" class="form-control" placeholder="Title" name="title">
                </div>
              </div>
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="text-black" for="fname">Bio</label>
                  <input type="text" id="fname" class="form-control" placeholder="Bio" name="bio">
                </div>
              </div>
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="text-black" for="fname">Facebook</label>
                  <input type="text" id="fname" class="form-control" placeholder="Facebook" name="facebook">
                </div>
              </div>
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="text-black" for="fname">Twitter</label>
                  <input type="text" id="fname" class="form-control" placeholder="Twitter" name="twitter">
                </div>
              </div>
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="text-black" for="fname">Linkedin</label>
                  <input type="text" id="fname" class="form-control" placeholder="Linkedin" name="linkedin">
                </div>
              </div>
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
